...
This repository carries the STAG-specific changes on top of upstream ChartFx 11.3.1. Build and install the local STAG artifacts with:

```sh
git clone https://github.com/saminco/chart-fx-STAG.git
cd chart-fx-STAG
